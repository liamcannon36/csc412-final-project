...
extern unsigned int numTravelersDone;
extern int travelerSleepTime;
extern bool keepGoing;
extern vector<Traveler> travelerList;
extern vector<thread*> threadPointerList;
//-----------------------------------------------------------------------------
//    Custom Data Type
//-----------------------------------------------------------------------------
enum class FontSize
...
void myTimerFunc(int value)
{
    ...
    glutTimerFunc(10 + travelerSleepTime/1000, myTimerFunc, 0);
    myDisplay();
    // check if any traveler terminated
    //    if a traveler has status TERMINATED
    //        join corresponding thread
